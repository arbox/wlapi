...
This library is a set of Ruby bindings for the following featuren. You may also be interested
in other language specific bindings:
...
== INSTALLATION
WLAPI is provided as a <tt>.gem</tt> package. Simply install it via {RubyGems}[http://rubygems.org/gems/wlapi].
